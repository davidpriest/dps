...
xmlns:svg="http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd" id="fo_common_params" version="1.0">
<!-- #TODO: move to common-utils.xsl -->
...
-->
    ...
    <xsl:attribute-set name="root.properties">
        ...
        <xsl:attribute name="role">
          <xsl:choose>
            <xsl:when test="count(/*/d:info//d:filename[@role='filename'])=1">
              <xsl:value-of select="/*/d:info//d:filename[@role='filename']"/>
            </xsl:when>
            <xsl:otherwise>
              <xsl:value-of select="/*[@xml:id]/@xml:id"/>
            </xsl:otherwise>

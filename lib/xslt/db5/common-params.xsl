<?xml version="1.0"?>
<!-- EXCEPTIONS TO STOCK ../../../docbook-xsl-ns-1.76.1 SETTINGS -->
<!-- **NOT** output specific -->
<!-- davidpriest.ca dps -->
...
xmlns:svg="http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd" id="db5_common_params" version="1.0">
...
<l:i18n xmlns:l="http://docbook.sourceforge.net/xmlns/l10n/1.0">
  <l:l10n xmlns:l="http://docbook.sourceforge.net/xmlns/l10n/1.0" language="en" english-language-name="English">
    <l:context name="xref">
      <l:template name="olink.document.citation" text=" in the %o"/>
      <l:template name="docname" text=" in the %o"/>
...
-->
    ...
    <xsl:param name="admon.graphics.path"><xsl:value-of select="$db5.path"/>/images/</xsl:param>
...
-->
    ...
    <xsl:param name="nominal.table.width">5in</xsl:param>
...
-->
    ...
    <xsl:param name="draft.watermark.image"><xsl:value-of select="$db5.path"/>/images/draft.png</xsl:param>
...
-->
    ...
    <xsl:param name="title.font.family" select="'sans-serif,serif,Symbol,ZapfDingbats,UnicodeSymbols'"/>
...
-->
    ...
    <xsl:attribute-set name="monospace.properties">
        ...
        <xsl:attribute name="font-size"><xsl:value-of select="$body.font.master * $monospace.font.scale"/>pt</xsl:attribute>
    </xsl:attribute-set>
    ...
    <xsl:attribute-set name="root.properties">
        ...
        <xsl:attribute name="xml:id">
            <xsl:value-of select="/*[@xml:id]/@xml:id"/>
        </xsl:attribute>
        <xsl:attribute name="role">
          <xsl:choose>
            <xsl:when test="count(/*/info//filename[@role='filename'])=1">
...
-->
    ...
    <xsl:attribute-set name="gui.font">
        <xsl:attribute name="font-family">sans-serif</xsl:attribute>
        <xsl:attribute name="font-weight">normal</xsl:attribute>
        <xsl:attribute name="font-size"><xsl:value-of select="$body.font.master * $gui.font.scale"/>pt</xsl:attribute>
    </xsl:attribute-set>
    <xsl:param name="monospace.font.scale">0.9</xsl:param>
    <xsl:param name="gui.font.scale">0.9</xsl:param>
</xsl:stylesheet>
